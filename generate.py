...
class CrosswordCreator():
    ...
    def count_conflicts(self, var, value, assignment):
        """count the number of values this val;ue rules out for neighboring variables
        """
        count = 0
        for neighbor in self.crossword.neighbors(var):
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        valori_domeniu = list(self.domains[var])
        valori_domeniu.sort(key=lambda x: self.count_conflicts(var, x, assignment))
    ...
    def select_unassigned_variable(self, assignment):
        ...
        unassigned_variables.sort(key=lambda var: (mrv(var), -degree(var)))
